...
import { LeaderboardChorusIcon } from '~/components/icons'
...
type ChorusIndexProps = InferPageProps<ChorusController, 'index'>

export default function ChorusIndex(props: ChorusIndexProps) {
  ...
  return (
    <>
      <Head
        title="Classement: Chorus"
        description="Consultez le classement des joueurs qui ramassent le plus de chorus."
        defaultOg
      />
      <DefaultLayout>
        <Page>
          <div className="flex flex-row flex-wrap gap-2 justify-between items-center">
            <PageTitle>Classement: Chorus</PageTitle>
...
const Podium = ({
  ...
  data: ChorusIndexProps['leaderboard'][number]['data'][number]
  ...
  return (
    <PodiumCard position={position}>
      ...
      <PodiumCardPedestal>
        ...
        <PodiumCardValue
          after={<LeaderboardChorusIcon className="h-5 w-auto invert dark:invert-0" />}
        >
          {data.value}
        </PodiumCardValue>
