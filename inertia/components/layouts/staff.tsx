  ...
  return (
    <div className="flex flex-row">
      <div className="flex flex-col w-full">
        <StaffHeader />
        <main className="flex min-h-[calc(100vh-(--spacing(16)))] flex-col gap-4 md:gap-8">
          <div className="mx-auto flex flex-col lg:grid w-full max-w-6xl items-start gap-4 p-4 lg:grid-cols-[250px_1fr]">
