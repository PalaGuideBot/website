    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            'flex items-center flex-wrap gap-1 px-2.5 py-1.5 rounded-lg bg-background overflow-hidden border hover:border-surface-300 dark:hover:border-surface-200 border-surface-200 dark:border-surface-100 outline-2 focus-within:outline focus-within:-outline-offset-1',
            {
