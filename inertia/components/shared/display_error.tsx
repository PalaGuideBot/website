...
interface DisplayErrorProps extends React.ComponentProps<'div'> {
  error?: PageError
}

export function DisplayError({ error, className, children, ...props }: DisplayErrorProps) {
  return (
      ...
      <div className="flex-1 flex flex-col gap-4 justify-evenly">
        <div className="flex flex-col items-center justify-center gap-4">
          <div className="space-y-1 text-center">
            ...
            <p className="text-lg text-muted-foreground">Une erreur est survenue.</p>
          </div>
